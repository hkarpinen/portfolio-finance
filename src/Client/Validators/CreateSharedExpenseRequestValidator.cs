...
public sealed class CreateGroupExpenseRequestValidator : AbstractValidator<CreateGroupExpenseCommand>
{
...
public sealed class UpdateGroupExpenseRequestValidator : AbstractValidator<UpdateGroupExpenseCommand>
{
