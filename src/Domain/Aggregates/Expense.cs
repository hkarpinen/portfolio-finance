...
public class Expense : IAggregateRoot
{
    ...
    /// whoever consumes it, so this never decides what the journalLine looks like.
    /// </summary>
    ...
    /// member settlement reads) and raises the fact. The ledger journalLine (Dr Vendor Payable / Cr the
