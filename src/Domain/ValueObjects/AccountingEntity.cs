...
/// <summary>
/// Whose books something belongs to: an id, and which space it came from. An expense, a schedule
/// and a ledger all belong to an entity; nothing else about them turns on which kind it is.
/// </summary>
public readonly record struct AccountingEntity(EntityKind Kind, Guid Id)
{
    ...
    /// Being in a group does not make its expenses yours.</summary>
