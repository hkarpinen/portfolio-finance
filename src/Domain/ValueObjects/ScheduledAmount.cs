...
/// <summary>
/// What a schedule charged from a given date onward.
///
/// A rent rise is a new version, not an edit. That is how an agreement actually changes, and it
/// means a charge generated for a date in the past picks up what was true THEN even if nobody had
...
/// </summary>
public sealed record ScheduledAmount(DateTime EffectiveFrom, decimal Amount)
{
    public static ScheduledAmount From(DateTime effectiveFrom, decimal amount) =>
