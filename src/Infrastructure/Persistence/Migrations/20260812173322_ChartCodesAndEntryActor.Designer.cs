...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260812173322_ChartCodesAndEntryActor")]
    partial class ChartCodesAndEntryActor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Finance.Domain.Aggregates.ChargeSchedule", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Amount", "Finance.Domain.Aggregates.ChargeSchedule.Amount#Money", b1 =>
                        {
                            b1.Property<decimal>("Amount")
                                .HasPrecision(18, 2)
                                .HasColumnType("numeric(18,2)")
