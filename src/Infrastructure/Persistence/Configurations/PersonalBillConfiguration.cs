...
internal sealed class PersonalBillConfiguration : IEntityTypeConfiguration<PersonalBill>
{
    public void Configure(EntityTypeBuilder<PersonalBill> builder)
    {
        builder.HasKey(b => b.Id);
        builder.Property(b => b.Id)
            .HasConversion(id => id.Value, v => new PersonalBillId(v));
