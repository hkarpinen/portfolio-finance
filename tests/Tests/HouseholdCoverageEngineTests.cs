...
public class GroupCoverageEngineTests
{
    ...
    private readonly IGroupCoverageEngine _engine = new GroupCoverageEngine();

    [Fact]
    public void BuildCoverageStatus_IncomeExceedsBills_ReturnsCovered()
    {
        var status = _engine.BuildCoverageStatus(
    ...
    public void BuildCoverageStatus_SetsAmountsCorrectly()
    {
        ...
        Assert.Equal(id, status.GroupId);
